...
namespace imacraft{
	CubeInstance::CubeInstance(Texture &texture) : cubeTexture(texture){
		...
		vertices[1].texCoords.x = 0.16f; vertices[1].texCoords.y = 1.f; 
		...
		vertices[2].texCoords.x = 0.16f; vertices[2].texCoords.y = 0.f; 
		...
		vertices[3].texCoords.x = 0.16f; vertices[3].texCoords.y = 0.f; 
		...
		vertices[6].texCoords.x = 0.16f; vertices[6].texCoords.y = 1.f; 
		...
		vertices[7].texCoords.x = 0.32f; vertices[7].texCoords.y = 1.f; 
		...
		vertices[8].texCoords.x = 0.32f; vertices[8].texCoords.y = 0.f; 
		...
		vertices[9].texCoords.x = 0.32f; vertices[9].texCoords.y = 0.f; 
		...
		vertices[10].texCoords.x = 0.16f; vertices[10].texCoords.y = 0.f; 
		...
		vertices[11].texCoords.x = 0.16f; vertices[11].texCoords.y = 1.f; 
		...
		vertices[12].texCoords.x = 0.32f; vertices[12].texCoords.y = 1.f; 
		...
		vertices[13].texCoords.x = 0.48f; vertices[13].texCoords.y = 1.f; 
		...
		vertices[14].texCoords.x = 0.48f; vertices[14].texCoords.y = 0.f; 
		...
		vertices[15].texCoords.x = 0.48f; vertices[15].texCoords.y = 0.f; 
		...
		vertices[16].texCoords.x = 0.32f; vertices[16].texCoords.y = 0.f; 
		...
		vertices[17].texCoords.x = 0.32f; vertices[17].texCoords.y = 1.f; 
		...
		vertices[18].texCoords.x = 0.48f; vertices[18].texCoords.y = 1.f; 
		...
		vertices[19].texCoords.x = 0.65f; vertices[19].texCoords.y = 1.f; 
		...
		vertices[20].texCoords.x = 0.65f; vertices[20].texCoords.y = 0.f; 
		...
		vertices[21].texCoords.x = 0.65f; vertices[21].texCoords.y = 0.f; 
		...
		vertices[22].texCoords.x = 0.48f; vertices[22].texCoords.y = 0.f; 
		...
		vertices[23].texCoords.x = 0.48f; vertices[23].texCoords.y = 1.f;
		...
		vertices[24].texCoords.x = 0.68f; vertices[24].texCoords.y = 0.f; 
		...
		vertices[25].texCoords.x = 0.83f; vertices[25].texCoords.y = 1.f; 
		...
		vertices[26].texCoords.x = 0.83f; vertices[26].texCoords.y = 0.f; 
		...
		vertices[27].texCoords.x = 0.83f; vertices[27].texCoords.y = 0.f; 
		...
		vertices[28].texCoords.x = 0.68f; vertices[28].texCoords.y = 0.f; 
		...
		vertices[29].texCoords.x = 0.68f; vertices[29].texCoords.y = 1.f;
		...
		vertices[30].texCoords.x = 0.84f; vertices[30].texCoords.y = 1.f; 
		...
		vertices[31].texCoords.x = 0.99f; vertices[31].texCoords.y = 1.f; 
		...
		vertices[32].texCoords.x = 0.99f; vertices[32].texCoords.y = 0.f; 
		...
		vertices[33].texCoords.x = 0.99f; vertices[33].texCoords.y = 0.f; 
		...
		vertices[34].texCoords.x = 0.84f; vertices[34].texCoords.y = 0.f; 
		...
		vertices[35].texCoords.x = 0.84f; vertices[35].texCoords.y = 1.f;
